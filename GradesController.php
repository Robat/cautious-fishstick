    ...
    public function ajaxGrades()
    {
        ...
        return DataTables::of($result)
            ...
            ->addColumn('action', function ($row) {
                return '<a class="btn btn-light"  data-toggle="modal" onclick="showEdit(' . $row->id . ',\'' . $row->grade . '\')"><i class="fa fa-edit"></i> 編輯</a><a class="btn btn-danger delete" data-id="' . $row->id . '" data-dept="' . $row->grade . '"><i class="fa fa-trash"></i> 刪除</a>';
            })
